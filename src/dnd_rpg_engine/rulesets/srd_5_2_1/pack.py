    ...
    catalog = {
        ...
        "coverage": {
            "implemented": [
                ...
                "offline SRD catalog compiler and SQLite query store",
                "spell catalog compiler",
                "class progression and subclass catalogs",
                "non-weapon magic-item metadata catalog",
                "monster stat catalog without action/gear prose",
                "travel/environment tables",
                "encounter XP budgets and CR XP tooling",
            ],
